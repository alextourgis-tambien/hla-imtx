...
(() => {
  ...
  const app = { version: '0.5.2', ready: false };
  window.HLAIMTX = app;
  ...
  const FADE_SELECTOR = '.number__wrapper, .hla__logo, .hla__hla-logo';
      ...
      function apply(next, force = false) {
        ...
        transitions = [
          ...
          gsap.to(next === 0 ? first : second, {
            ...
            scale: visible ? 1 : 0, duration: 0.85, delay: switching ? 0.4 : 0, ease: 'power2.inOut',
            onComplete: () => {
